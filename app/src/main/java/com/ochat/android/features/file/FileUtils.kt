package com.ochat.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.ochat.android.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.ochat.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.ochat.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.ochat.android.model.BitchatMessageType.Audio
            else -> com.ochat.android.model.BitchatMessageType.File
        }
    }
