package com.ochat.android.onboarding
...
class PermissionManager(private val context: Context) {
    ...
    private fun shouldRequireWifiAwarePermission(): Boolean {
        ...
        val enabled = try {
            com.ochat.android.ui.debug.DebugPreferenceManager.getWifiAwareEnabled(false)
        } catch (_: Exception) {
            false
        }
        ...
        return try {
            com.ochat.android.wifiaware.WifiAwareSupport.isSupported(context)
        } catch (_: Exception) {
            false
        }
    }
