...
import com.ochat.android.util.AppConstants
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.*
import kotlinx.coroutines.Job
import com.ochat.android.ui.debug.DebugSettingsManager
import com.ochat.android.ui.debug.DebugScanResult
...
class BluetoothGattClientManager(
    ...
    private fun handleScanResult(result: ScanResult) {
        ...
        val dbg = try { com.ochat.android.ui.debug.DebugSettingsManager.getInstance() } catch (_: Exception) { null }
