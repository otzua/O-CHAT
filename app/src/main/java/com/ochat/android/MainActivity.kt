...
import com.ochat.android.onboarding.BluetoothCheckScreen
import com.ochat.android.onboarding.BluetoothStatus
import com.ochat.android.onboarding.BluetoothStatusManager
import com.ochat.android.onboarding.BatteryOptimizationManager
import com.ochat.android.onboarding.BatteryOptimizationPreferenceManager
import com.ochat.android.onboarding.BatteryOptimizationScreen
import com.ochat.android.onboarding.BatteryOptimizationStatus
import com.ochat.android.onboarding.BackgroundLocationPermissionScreen
import com.ochat.android.onboarding.InitializationErrorScreen
import com.ochat.android.onboarding.InitializingScreen
import com.ochat.android.onboarding.LocationCheckScreen
import com.ochat.android.onboarding.LocationStatus
import com.ochat.android.onboarding.LocationStatusManager
import com.ochat.android.onboarding.OnboardingCoordinator
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.ochat.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.ochat.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.ochat.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.ochat.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        meshService = com.ochat.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        unifiedMeshService = com.ochat.android.service.MeshServiceHolder.getUnifiedOrCreate(applicationContext)
    ...
    private fun OnboardingFlowScreen(modifier: Modifier = Modifier) {
        ...
        when (onboardingState) {
            ...
            OnboardingState.CHECKING, OnboardingState.INITIALIZING, OnboardingState.COMPLETE -> {
                // Back navigation is owned by the NavHost inside OChatApp, which pops the
                // conversation route and lets the system exit the app from the home route.
                // An activity-level callback here would swallow the press before Navigation
                // saw it, ending the private chat without leaving the screen.
    ...
    private fun checkBluetoothAndProceed() {
        ...
        val bleRequired = try { com.ochat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        if (!bleRequired) {
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.ochat.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun handleLocationEnabled() {
        ...
        com.ochat.android.wifiaware.WifiAwareController.startIfPossible()
        checkBatteryOptimizationAndProceed()
    }
    ...
    private fun handleOnboardingComplete() {
        ...
        val bleRequired2 = try { com.ochat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        when {
    ...
    private fun startMeshForegroundServiceBestEffort() {
        ...
        try {
            com.ochat.android.service.MeshForegroundService.start(applicationContext)
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.ochat.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.ochat.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.ochat.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.ochat.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.ochat.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.ochat.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.ochat.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.ochat.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.ochat.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.ochat.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.ochat.android.geohash.GeohashChannelLevel.REGION
                        else -> com.ochat.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.ochat.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.ochat.android.geohash.ChannelID.Location(geohashChannel)
