...
import com.ochat.android.nostr.GeohashMessageHandler
import com.ochat.android.nostr.GeohashRepository
import com.ochat.android.nostr.NostrDirectMessageHandler
import com.ochat.android.nostr.NostrIdentityBridge
import com.ochat.android.nostr.NostrProtocol
import com.ochat.android.nostr.NostrRelayManager
import com.ochat.android.nostr.NostrSubscriptionManager
import com.ochat.android.nostr.PoWPreferenceManager
import com.ochat.android.nostr.GeohashAliasRegistry
import com.ochat.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.ochat.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.ochat.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.ochat.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.ochat.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.ochat.android.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.ochat.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.ochat.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.ochat.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.ochat.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.ochat.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.ochat.android.geohash.ChannelID.Mesh -> {
            ...
            is com.ochat.android.geohash.ChannelID.Location -> {
