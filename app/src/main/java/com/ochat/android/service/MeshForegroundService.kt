package com.ochat.android.service
...
import com.ochat.android.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.ochat.android.service.START"
        const val ACTION_STOP = "com.ochat.android.service.STOP"
        const val ACTION_QUIT = "com.ochat.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.ochat.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.ochat.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private val unifiedMeshService: com.ochat.android.mesh.MeshService?
    ...
    private fun ensureMeshStarted() {
        ...
        val bleEnabled = try {
            com.ochat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true)
        } catch (_: Exception) {
            true
        }
        if (!bleEnabled) {
