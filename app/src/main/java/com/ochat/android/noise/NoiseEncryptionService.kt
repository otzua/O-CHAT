package com.ochat.android.noise

import android.content.Context
import android.util.Log
import com.ochat.android.identity.SecureIdentityStateManager
import com.ochat.android.mesh.PeerFingerprintManager
import com.ochat.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.ochat.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.ochat.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.ochat.android.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.ochat.android.protocol.BitchatPacket): com.ochat.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.ochat.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
